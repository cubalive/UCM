...
router.get("/api/trips/:id", authMiddleware, requireRole("ADMIN", "DISPATCH", "VIEWER", "SUPER_ADMIN", "COMPANY_ADMIN", "CLINIC_USER"), requireTenantScope, getTripByIdHandler as any);
router.post("/api/trips", authMiddleware, requireRole("ADMIN", "DISPATCH", "VIEWER", "COMPANY_ADMIN", "CLINIC_USER", "SUPER_ADMIN"), requireTenantScope, idempotencyMiddleware, createTripHandler as any);
...
router.patch("/api/trips/:id/cancel-request", authMiddleware, requireRole("VIEWER"), requireTenantScope, cancelRequestHandler as any);
...
router.post("/api/trips/:id/signature/clinic", authMiddleware, requireRole("CLINIC_USER", "SUPER_ADMIN", "ADMIN", "DISPATCH", "COMPANY_ADMIN"), requireTenantScope, clinicSignatureHandler as any);
...
router.get("/api/trips/:id/pdf", authMiddleware, requireRole("SUPER_ADMIN", "ADMIN", "DISPATCH", "COMPANY_ADMIN", "CLINIC_USER", "DRIVER"), requireTenantScope, getTripPdfHandler as any);
router.get("/api/trips/:id/pdf/download", authMiddleware, requireRole("SUPER_ADMIN", "ADMIN", "DISPATCH", "COMPANY_ADMIN", "CLINIC_USER", "DRIVER"), requireTenantScope, downloadTripPdfHandler as any);

router.get("/api/trips/:id/invoice", authMiddleware, requireRole("SUPER_ADMIN", "ADMIN", "DISPATCH", "COMPANY_ADMIN", "CLINIC_USER"), requireTenantScope, getTripInvoiceHandler as any);
