  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border [border-color:var(--button-outline)] shadow-xs hover:bg-accent hover:text-accent-foreground active:scale-[0.98]",
        secondary:
          "border bg-secondary text-secondary-foreground border-secondary-border shadow-xs hover:shadow-md active:scale-[0.98]",
        ghost:
