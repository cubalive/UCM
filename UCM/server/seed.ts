...
export async function seedData() {
  ...
  await storage.createTrip({ publicId: await generatePublicId(), cityId: houston.id, patientId: p1.id, driverId: d1.id, vehicleId: v1.id, clinicId: c1.id, pickupAddress: "1234 Main St, Houston, TX 77002", dropoffAddress: "6411 Fannin St, Houston, TX 77030", pickupLat: 29.7545, pickupLng: -95.3592, dropoffLat: 29.7067, dropoffLng: -95.3991, scheduledDate: "2026-02-13", scheduledTime: "09:00", pickupTime: "09:00", estimatedArrivalTime: "09:30", status: "SCHEDULED", notes: "Wheelchair patient - needs ramp access" });
  await storage.createTrip({ publicId: await generatePublicId(), cityId: houston.id, patientId: p2.id, driverId: d2.id, vehicleId: v2.id, clinicId: c2.id, pickupAddress: "5678 Westheimer Rd, Houston, TX 77057", dropoffAddress: "6565 Fannin St, Houston, TX 77030", pickupLat: 29.7543, pickupLng: -95.4615, dropoffLat: 29.7080, dropoffLng: -95.3993, scheduledDate: "2026-02-13", scheduledTime: "10:30", pickupTime: "10:30", estimatedArrivalTime: "11:00", status: "ASSIGNED", notes: null });
  ...
  await storage.createTrip({ publicId: await generatePublicId(), cityId: dallas.id, patientId: p3.id, driverId: d3.id, vehicleId: v3.id, clinicId: c3.id, pickupAddress: "910 Elm St, Dallas, TX 75202", dropoffAddress: "3500 Gaston Ave, Dallas, TX 75246", pickupLat: 32.7767, pickupLng: -96.7970, dropoffLat: 32.7877, dropoffLng: -96.7785, scheduledDate: "2026-02-13", scheduledTime: "14:00", pickupTime: "14:00", estimatedArrivalTime: "14:30", status: "IN_PROGRESS", notes: null });
  await storage.createTrip({ publicId: await generatePublicId(), cityId: houston.id, patientId: p1.id, driverId: d1.id, vehicleId: v1.id, clinicId: c1.id, pickupAddress: "6411 Fannin St, Houston, TX 77030", dropoffAddress: "1234 Main St, Houston, TX 77002", pickupLat: 29.7067, pickupLng: -95.3991, dropoffLat: 29.7545, dropoffLng: -95.3592, scheduledDate: "2026-02-12", scheduledTime: "11:00", pickupTime: "11:00", estimatedArrivalTime: "11:30", status: "COMPLETED", notes: "Return trip" });
